...
if("TRUE" STREQUAL "TRUE")
  set(block_grasp_generator_SOURCE_PREFIX /home/visual-servoing/ros/ws_baxter/src/block_grasp_generator)
  set(block_grasp_generator_DEVEL_PREFIX /home/visual-servoing/ros/ws_baxter/devel)
  ...
  set(block_grasp_generator_INSTALL_PREFIX /home/visual-servoing/ros/ws_baxter/install)
...
if(NOT "/home/visual-servoing/ros/ws_baxter/src/block_grasp_generator/include" STREQUAL "")
  set(block_grasp_generator_INCLUDE_DIRS "")
  set(_include_dirs "/home/visual-servoing/ros/ws_baxter/src/block_grasp_generator/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'block_grasp_generator' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/visual-servoing/ros/ws_baxter/src/block_grasp_generator/${idir}'.  Ask the maintainer 'Dave Coleman <davetcoleman@gmail.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  _pack_libraries_with_build_configuration(block_grasp_generator_LIBRARIES ${block_grasp_generator_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${block_grasp_generator_dep}_LIBRARIES})
  _list_append_deduplicate(block_grasp_generator_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(block_grasp_generator_LIBRARIES ${block_grasp_generator_LIBRARIES})
