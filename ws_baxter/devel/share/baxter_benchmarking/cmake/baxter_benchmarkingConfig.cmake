...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'baxter_benchmarking' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/visual-servoing/ros/ws_baxter/src/baxter_cpp/baxter_benchmarking/${idir}'.  Ask the maintainer 'Dave Coleman <davetcoleman@gmail.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  _pack_libraries_with_build_configuration(baxter_benchmarking_LIBRARIES ${baxter_benchmarking_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${baxter_benchmarking_dep}_LIBRARIES})
  _list_append_deduplicate(baxter_benchmarking_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(baxter_benchmarking_LIBRARIES ${baxter_benchmarking_LIBRARIES})
