...
if("TRUE" STREQUAL "TRUE")
  set(baxter_control_SOURCE_PREFIX /home/visual-servoing/ros/ws_baxter/src/baxter_cpp/baxter_control)
  set(baxter_control_DEVEL_PREFIX /home/visual-servoing/ros/ws_baxter/devel)
  ...
  set(baxter_control_INSTALL_PREFIX /home/visual-servoing/ros/ws_baxter/install)
...
if(NOT "/home/visual-servoing/ros/ws_baxter/src/baxter_cpp/baxter_control/include" STREQUAL "")
  set(baxter_control_INCLUDE_DIRS "")
  set(_include_dirs "/home/visual-servoing/ros/ws_baxter/src/baxter_cpp/baxter_control/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'baxter_control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/visual-servoing/ros/ws_baxter/src/baxter_cpp/baxter_control/${idir}'.  Ask the maintainer 'Dave Coleman <davetcoleman@gmail.com>' to fix it.")
    endif()
    _list_append_unique(baxter_control_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "baxter_utilities;baxter_to_csv;arm_interface")
...
set(depends "moveit_ros_planning_interface;std_msgs;roscpp;baxter_core_msgs;controller_manager;transmission_interface;hardware_interface;sensor_msgs;joint_limits_interface;trajectory_msgs")
foreach(depend ${depends})
  ...
  _pack_libraries_with_build_configuration(baxter_control_LIBRARIES ${baxter_control_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${baxter_control_dep}_LIBRARIES})
  _list_append_deduplicate(baxter_control_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(baxter_control_LIBRARIES ${baxter_control_LIBRARIES})
