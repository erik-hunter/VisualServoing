...
cd "/home/visual-servoing/ros/ws_baxter/src/ros_control/controller_manager"
...
/usr/bin/env \
    ...
    build --build-base "/home/visual-servoing/ros/ws_baxter/build/ros_control/controller_manager" \
    install \
    $DESTDIR_ARG \
