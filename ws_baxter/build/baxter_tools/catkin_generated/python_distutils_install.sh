...
cd "/home/visual-servoing/ros/ws_baxter/src/baxter_tools"
...
/usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/visual-servoing/ros/ws_baxter/src/baxter_tools/setup.py" \
    build --build-base "/home/visual-servoing/ros/ws_baxter/build/baxter_tools" \
    install \
    $DESTDIR_ARG \
