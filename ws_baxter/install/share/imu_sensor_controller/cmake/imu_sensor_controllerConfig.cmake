...
foreach(depend ${depends})
  ...
  list(APPEND imu_sensor_controller_LIBRARIES ${${imu_sensor_controller_dep}_LIBRARIES})
...
if(imu_sensor_controller_LIBRARIES)
  _remove_duplicate_libraries(imu_sensor_controller_LIBRARIES imu_sensor_controller_LIBRARIES)
endif()
